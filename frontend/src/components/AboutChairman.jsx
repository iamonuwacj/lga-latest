...
const AboutChairman = () => {
  ...
  return (
    <section id="city" className="lg:p-[5%] p-[10%] bg-gray-100 flex flex-wrap w-full
        justify-between space-y-10 items-center">
        <div className="lg:w-[50%] w-full space-y-3 ">
            <h1 className="text-5xl mb-10">About the Chairman</h1>
            ...
            <div className="flex justify-center lg:justify-start text-white text-center">
                <a href="/chairman" className="hover:bg-green-600 mt-5 block bg-green-600 w-40 px-5 
                py-2 rounded-full">Learn More</a>
            </div>
        </div>

        <div className="lg:w-[45%] h-[50vh] md:px-20 lg:px-0 bg-black">
            <img src="" alt="" />
        </div>
    </section>
  )
